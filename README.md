...
If you do not have `JRE` you can download it from [here](https://www.oracle.com/java/technologies/downloads/). If your `JRE` is installed correctly you should have a file `javaw.exe` under the folder `Path\bin`.
