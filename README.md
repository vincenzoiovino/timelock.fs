...
Once you edited the file `install.bat` as described before, you can just run `install.bat`, grant admin permissions (needed to install the Windows extensions) and you are done.
